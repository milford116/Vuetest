...
$(function() {
    ...
    $("#mobile-collapse,#mobile-collapse1").on("click", function(e) {
        ...
        $(".pcoded-submenu > li").on("click", function(e) {
            console.log('ohe')
            $(window)[0].innerWidth < 992 && ($(".pcoded-navbar").removeClass("mob-open"), e.stopPropagation())
            $(".mobile-menu").removeClass("on")
        }),

        $(".nav-link").on("click", function() {

            if (!$(this).closest('.nav-link').parent().hasClass('pcoded-trigger')) {

                $(".pcoded-trigger").removeClass("active pcoded-trigger")
            }

            $(this).closest('.nav-link').parent().toggleClass("active pcoded-trigger")

        }),

        $(".nav2-link").on("click", function() {

            if (!$(this).closest('.nav2-link').parent().hasClass('pcoded-trigger')) {

                $(".nav2-link").parent().removeClass("active pcoded-trigger")
            }

            $(this).closest('.nav2-link').parent().toggleClass("active pcoded-trigger")
